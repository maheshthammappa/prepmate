...
public class InterviewController {
    ...
    public QuestionResponse generateQuestions(@RequestBody QuestionGenRequest request) {
        ...
        List<prepintai.interview.dto.QuestionEntry> finalQuestions = new java.util.ArrayList<>();
        int maxAttempts = 3;
        int attempt = 0;
        ...
        List<prepintai.interview.dto.QuestionEntry> processed = new java.util.ArrayList<>();
        for (int i = 0; i < finalQuestions.size(); i++) {
            var q = finalQuestions.get(i);
            processed.add(new prepintai.interview.dto.QuestionEntry(i + 1, q.questionText()));
        }
