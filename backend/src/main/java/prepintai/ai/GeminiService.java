...
public class GeminiService {
     ...
     */
    public QuestionResponse generatePracticeQuestions(List<prepintai.interview.PracticeQuestion> weakQuestions) {
        ...
        for (int i = 0; i < weakQuestions.size(); i++) {
            prepintai.interview.PracticeQuestion q = weakQuestions.get(i);
